    ...
    data() {
      return {
        ...
        headers: [
          ...
          { text: "Umumiy miqdor", value: "totalAmount", align: 'center', class: "header-style", divider: true},
          { text: "Umumiy narx", value: "totalPrice", align: 'center', class: "header-style", divider: true},
        ],
